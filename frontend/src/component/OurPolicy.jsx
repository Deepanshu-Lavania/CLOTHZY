...
function OurPolicy() {
  return (
    <>
      <hr className=" w-[100vw] mx-auto  opacity-50 " />
      <div className="w-[100vw]   flex items-center justify-start flex-col  bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px]">
        <div className="h-[8%] w-[100%] text-center mt-[60px] md:mt-[20px] ">
